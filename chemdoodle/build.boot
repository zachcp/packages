...
(deftask package []
  (comp
    (download :url "http://web.chemdoodle.com/downloads/ChemDoodleWeb-7.0.1.zip"
              ...
              :unzip true)
    (sift :move {#"^ChemDoodleWeb-([\d\.]*)/ChemDoodleWeb\.js"      "cljsjs/chemdoodle/development/chemdoodle.inc.js"
                 #"^ChemDoodleWeb-([\d\.]*)/install/ChemDoodleWeb\.js" "cljsjs/chemdoodle/production/chemdoodle.min.js"})
    (sift :include #{#"^cljsjs"})
